...
public class UserServiceImplUnitTest {
    ...
    public void setUp(){
        ...
        userToBeTestedAgainst = new User(uuidToBeTestedAgainst.toString()).setFirstName("John").setLastName("Doe").setEmail("john.doe@noseryoung.ch").setEnabled(true).setPassword(bCryptPasswordEncoder.encode(UUID.randomUUID().toString())).setRoles(rolesToBeTestedAgainst);
